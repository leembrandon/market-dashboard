    ...
    <div className={s.page}>
      ...
      {!loading&&!error&&data&&(
        <div style={{animation:"fadeIn 0.3s ease-out"}}>
          ...
          {/* ── Education accordion ── */}
          <EducationAccordion content={EDUCATION.ib} />
